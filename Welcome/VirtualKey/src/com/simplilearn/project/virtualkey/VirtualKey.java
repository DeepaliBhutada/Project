 ...
 * Student: Deepali Bhutada
 * Code Finished Date: 20 feb 2023
 * Code Started Date: 11 feb 2023 (draft version) *
 * ********************************************* */
...
//Open a Scanner to read input from the console
	...
	private static void welcomeScreen() {
		...
		System.out.println("Full Stack Developer Name: Deepali Bhutada");
		System.out.println("************************************************\n");
	}// end welcome()
...
//couldn't return r from here; have to move it outside of the try-catch block
			...
			sc.nextLine(); // consuming the input that was causing the exception, clearing the input
...
//User will input their selection
	...
	private static void addFile() throws IOException {
		...
		if (Files.notExists(filePath)) {
			...
			System.out.println("File created successfully!"); // doesn't distinguish between NIA.html and nia.html are
																// the same. okay per requirement
...
//This (debug) method is printing the fileList Collection directly to the    console
	// TODO: The method keeps double printing the file name to the console;
	// further debug needed. Will not have time to fix before submission.
...
// TODO Auto-generated catch block
		...
		System.out.println("There are (numFilesinDirectory = ) " + numFilesinDirectory + " files in "
